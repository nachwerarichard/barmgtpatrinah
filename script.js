...
function getDepartmentFromText(text) {
    ...
    return 'Bar'; // Default to Bar if no match
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('search-inventory-low').addEventListener('change', fetchInventory);
    ...
    document.getElementById('cash-filter-responsible').addEventListener('change', fetchCashJournal);
    document.getElementById('report-start-date').addEventListener('change', generateReports);
    document.getElementById('report-end-date').addEventListener('change', generateReports);
